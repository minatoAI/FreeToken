...
_MMVQ = _STANDARD_AND_K | _IQ
# The vendored MMQ switch covers standard and K-quants only. IQ types use
# MMVQ for small batches and the dequant fallback for larger batches.
_MMQ = _STANDARD_AND_K
_DEQUANT = _STANDARD_AND_K | _IQ
